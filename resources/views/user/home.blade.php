...
<body >
        ...
        <!-- Modal -->
        <div class="modal fade" id="money" tabindex="-1" role="dialog" aria-labelledby="moneyLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="moneyLabel">Nạp tiền vào tài khoản</h5>
